...
# data folder:
language_id="de"
csv_prepared_folder="/home/mipuc/lorgu.accent-recog-slt2022/CommonAccent/data/at_augmented_dev_regions"
output_dir="/home/mipuc/lorgu.accent-recog-slt2022/CommonAccent/results/W2V2/AT"
...
$cmd python accent_id/train_w2v2_coord.py accent_id/hparams/train_w2v2_xlsr_at_coord.yaml \
    --seed=$seed \
    --skip_prep="True" \
